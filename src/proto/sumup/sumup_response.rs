...
use crate::proto::response::{ReadResponse, ReadWriteResponse, WriteResponse};
...
mod tests {
    ...
    #[test]
    fn sumup_read_write_write_to_test() {
    ...
    #[test]
    fn sumup_read_write_read_from_test() {
        #[rustfmt::skip]
        let data = vec![
            0,0,0,0,        //result response 1
            2,0,0,0,        //data length response 1
